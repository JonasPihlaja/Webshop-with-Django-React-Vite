"""
Django settings for sellersmarket project.
...
SECRET_KEY = 'django-insecure-5beu6(lpcj!fi)&szm%(770(y_qr*lx625)78h2y3fjmvq#3l+'
...
ROOT_URLCONF = 'sellersmarket.urls'
...
WSGI_APPLICATION = 'sellersmarket.wsgi.application'
...
VITE_APP_DIR = PROJECT_ROOT / "frontend" / "src"
